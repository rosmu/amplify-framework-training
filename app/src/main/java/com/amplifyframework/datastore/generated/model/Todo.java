...
@ModelConfig(pluralName = "Todos", authRules = {
        @AuthRule(allow = AuthStrategy.PUBLIC, operations = {ModelOperation.CREATE, ModelOperation.READ, ModelOperation.UPDATE, ModelOperation.DELETE})
})
public final class Todo implements Model {
    public static final QueryField ID = field("Todo", "id");
    public static final QueryField DESCRIPTION = field("Todo", "description");
    public static final QueryField IS_COMPLETED = field("Todo", "isCompleted");
    private final @ModelField(targetType = "ID", isRequired = true)
    String id;
    private final @ModelField(targetType = "String", isRequired = true)
    String description;
    private final @ModelField(targetType = "Boolean")
    Boolean isCompleted;
    ...
    private Todo(String id, String description, Boolean isCompleted) {
        this.id = id;
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            return ObjectsCompat.equals(getId(), todo.getId()) &&
                    ...
                    ObjectsCompat.equals(getIsCompleted(), todo.getIsCompleted()) &&
    ...
    public static class Builder implements DescriptionStep, BuildStep {
        private String id;
    ...
    public final class CopyOfBuilder extends Builder {
        private CopyOfBuilder(String id, String description, Boolean isCompleted) {
            super.id(id);
